...
const ITEMS: ShopItem[] = [
  ...
  { id:7,  name:'Топы',               category:'Одежда',           spec:'Тренировочные топы',                     price:4500, priceLabel:'от 4 500 ₽',    photo:'/images/shops/55.png', bgColor:'#e6e6e6', tag:'',          popular:88, isNew:true  },
  { id:8,  name:'Майки',              category:'Одежда',           spec:'Тренировочные майки',                    price:3600, priceLabel:'от 3 600 ₽',    photo:'/images/shops/1010.png', bgColor:'#e6e6e6', tag:'',          popular:85, isNew:false },
  { id:9,  name:'Шорты',              category:'Одежда',           spec:'Шорты для тренировок',                   price:4250, priceLabel:'от 4 250 ₽',    photo:'/images/shops/88.png', bgColor:'#e6e6e6', tag:'Проверено', popular:86, isNew:false },
  { id:10, name:'Футболки',           category:'Одежда',           spec:'Футболки для тренировок',                price:3950, priceLabel:'от 3 950 ₽',    photo:'/images/shops/15.png', bgColor:'#e6e6e6', tag:'',          popular:80, isNew:false },
  /* ПРАВКА: разделены лосины и бриджи */
  { id:11, name:'Лосины',             category:'Одежда',           spec:'Лосины для тренировок',                  price:5900, priceLabel:'от 2 100 ₽',    photo:'/images/shops/33.png', bgColor:'#e6e6e6', tag:'',          popular:90, isNew:false },
  { id:12, name:'Носки',              category:'Одежда',           spec:'Носки для тренировок',                   price:900, priceLabel:'от 900 ₽',       photo:'/images/shops/1414.png', bgColor:'#e6e6e6', tag:'',          popular:82, isNew:false },
  { id:13, name:'Кофты',              category:'Одежда',           spec:'Спортивные кофты',                       price:7500, priceLabel:'от 7 500 ₽',    photo:'/images/shops/2020.png', bgColor:'#e6e6e6', tag:'',          popular:75, isNew:true  },
  { id:14, name:'Лонгсливы',          category:'Одежда',           spec:'Лонгсливы для тренировок',               price:4500, priceLabel:'от 4 500 ₽',    photo:'/images/shops/322.png', bgColor:'#e6e6e6', tag:'',          popular:72, isNew:false },
  { id:15, name:'Спортивные костюмы', category:'Одежда',           spec:'Костюмы для тренировок',                 price:10550, priceLabel:'от 10 550 ₽',  photo:'/images/shops/66.png', bgColor:'#e6e6e6', tag:'Топ выбор', popular:88, isNew:false },
  { id:16, name:'Рюкзаки',            category:'Чехлы и рюкзаки',  spec:'Рюкзаки для гимнастики',                 price:6500, priceLabel:'от 6 500 ₽',    photo:'/images/shops/2.png',  bgColor:'#e6e6e6',tag:'Топ выбор', popular:92, isNew:false },
  ...
  { id:21, name:'Полупальцы',         category:'Сопутствующие',   spec:'Полупальцы для гимнастики',               price:500,  priceLabel:'от 500 ₽',      photo:'/images/shops/77.png', bgColor:'#e6e6e6', tag:'',          popular:88, isNew:false },
  { id:22, name:'Гетры',              category:'Сопутствующие',   spec:'Гетры для гимнастики',                    price:2450,  priceLabel:'от 2 450 ₽',   photo:'/images/shops/133.png', bgColor:'#e6e6e6', tag:'',          popular:82, isNew:false },
